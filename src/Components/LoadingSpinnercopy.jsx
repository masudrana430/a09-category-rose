       ...
       C40,32 32,32 24,24"
        ...
        <div className="text-center">
          ...
          <p
            lang="ar"
            dir="rtl"
            className="mt-2 text-[30px] md:text-[30px] font-bold bg-gradient-to-r from-[#632EE3] to-[#9F62F2]
    bg-clip-text text-transparent"
          >
            السَّلامُ عَلَيْكُمْ وَرَحْمَةُ اللهِ وَبَرَكاتُهُ
          </p>
          <p className="text-[20px] md:text-[20px] font-semibold text-white/150">
          ...
          {/* Translation */}
          <p className="mt-2 text-[20px] md:text-[20px] font-semibold text-white/200">
            {verse.en}
          </p>
        </div>
      </div>
...
export default LoadingSpinnerCopy;